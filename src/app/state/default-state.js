  ...
  function createDefaultState() {
    ...
    return {
      ...
      settings: {
        ...
        transition: "fade",
        frameShadow: false,
        tableTextColors: ["#1d1917", "#0a66ff", "#0c6291", "#b42318", "#027a48", "#7a5af8"],
        savedColors: ["#1d1917", "#0a66ff", "#0c6291", "#b42318", "#027a48", "#7a5af8"],
      },
      mediaLibrary: [],

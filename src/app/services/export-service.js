    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .slide-html-embed-shell {
        position: absolute;
        left: calc(var(--slide-html-embed-x, 0%) + ((100% - var(--slide-html-embed-scale, 100%)) / 2));
        top: calc(var(--slide-html-embed-y, 0%) + ((100% - var(--slide-html-embed-scale, 100%)) / 2));
        width: var(--slide-html-embed-scale, 100%);
        height: var(--slide-html-embed-scale, 100%);
        min-height: 0;
        margin-top: 0;
        overflow: hidden;
        border: 0;
